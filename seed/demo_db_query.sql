...
CREATE TABLE harvester (
    ...
    company_famer_id INT NOT NULL DEFAULT '1', 
    FOREIGN KEY (company_famer_id) REFERENCES seed_company(id)ON DELETE CASCADE
);
...
CREATE TABLE manufactuer(
    ...
    product_id VARCHAR(255) NOT NULL DEFAULT '1',
    product_name VARCHAR(255) NOT NULL,
    weight VARCHAR(255) NOT NULL,
    manufactuer_name VARCHAR(255) NOT NULL DEFAULT 'Gizmo'
);
